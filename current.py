...
def analyze_text():
    try:
        ...
        prompt = (
            ...
            "Highlight inconsistencies, overuse of common words, or overly polished phrasing that might indicate AI involvement. Please note, human traits is focused only on errors, depends on how many errors in the text means that is a human trait, but it is overall good, accurate, no errors, it means it is ai "
            "If you suspect that is a content is AI and a very few signs of human traits, then don't be shy to boost the decimal of likbability of ai_probability. I want confidence  "
            ...
            "Human-Like Traits:\n"
            "-\n\n"
            "At the end of your explanation, strictly output a scoring decimal in JSON format with 'ai_probability' and 'human_probability example 0.90 and 0.10'.\n\n"
            f"Text: {essay}"
        )
